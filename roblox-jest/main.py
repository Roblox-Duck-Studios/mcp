"""Roblox Jest documentation MCP server."""
...
DOC_PATHS = {
    ...
    "setupTests": "setup-tests.md",
    "bestPractices": "best-practices.md",
    # Guides
    "writingTests": "guides/writing-tests.md",
    "testStructure": "guides/test-structure.md",
    "coverage": "guides/coverage.md",
    "jestAssassin": "guides/jest-assassin.md",
    "globalMocks": "guides/global-mocks.md",
}

mcp = FastMCP("roblox-jest")
...
def get_documentation(doc_key: str) -> str:
    """Fetch specific Roblox Jest documentation content by key."""
...
def search_documentation(query: str) -> str:
    """Search Roblox Jest documentation for specific topics or keywords."""
    results = []
...
def list_documentation() -> str:
    """List all available Roblox Jest documentation pages with metadata."""
    output = "# Available Roblox Jest Documentation\n\n"
        ...
        categories[category].append(
            {
                ...
                "path": path,
                "title": title,
                "description": f"Roblox Jest documentation: {title}",
            }
        )
